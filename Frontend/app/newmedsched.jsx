        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.column}>
            ...
            <TextInput 
              ...
              multiline 
              numberOfLines={4} 
              onChangeText={(text) => setFormData({ ...formData, medicationNotes: text })} 
            />
            <Text style={styles.label}>Physician ID</Text>
            <TextInput 
              style={styles.input} 
              onChangeText={(text) => setFormData({ ...formData, physicianID: text })} 
            />
          </View>
        </View>

        <View style={styles.buttonContainer}>
          <TouchableOpacity onPress={() => setModalVisible(true)} style={[styles.button, styles.leaveButton]}>
      ...
      <Modal visible={modalVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalMessage}>Are you sure you want to cancel scheduling this medication?</Text>
