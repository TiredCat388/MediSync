...
const Sidebar = () => {
  ...
  return (
    <Animated.View
      style={[
        styles.sidebar,
        { width: sidebarWidth, backgroundColor: sidebarColor },
      ]}
    >
      {/* Sidebar Container */}
      <View style={styles.sidebarContent}>
        ...
        <View style={styles.iconsContainer}>
          <TouchableOpacity
            onPress={() => handleSidebarPress("menu")}
            style={styles.iconLabelContainer}
          >
            <FontAwesome name="bars" size={24} color={iconColor} />
            {isSidebarExpanded && (
              <Text style={[styles.iconLabel, { color: textColor }]}>Menu</Text>
            )}
          </TouchableOpacity>

          <TouchableOpacity
            onPress={() => handleSidebarPress("file")}
            style={styles.iconLabelContainer}
          >
          ...
          <TouchableOpacity
            onPress={() => handleSidebarPress("logout")}
            style={styles.iconLabelContainer}
          >
